class FragrancesModel {
  List<FragranceProducts>? products;
  int? total;
  int? skip;
  int? limit;

  FragrancesModel({this.products, this.total, this.skip, this.limit});

  FragrancesModel.fromJson(Map<String, dynamic> json) {
    if (json['products'] != null) {
      products = <FragranceProducts>[];
      json['products'].forEach((v) {
        products!.add(new FragranceProducts.fromJson(v));
      });
    }
    total = json['total'];
    skip = json['skip'];
...
class FragranceProducts {
  ...
  FragranceProducts.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
