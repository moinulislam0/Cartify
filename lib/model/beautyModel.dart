class BeautyModel {
  List<BeautyProducts>? products;
  int? total;
  int? skip;
  int? limit;

  BeautyModel({this.products, this.total, this.skip, this.limit});

  BeautyModel.fromJson(Map<String, dynamic> json) {
    if (json['products'] != null) {
      products = <BeautyProducts>[];
      json['products'].forEach((v) {
        products!.add(new BeautyProducts.fromJson(v));
      });
    }
    total = json['total'];
    skip = json['skip'];
...
class BeautyProducts {
  ...
  BeautyProducts.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
